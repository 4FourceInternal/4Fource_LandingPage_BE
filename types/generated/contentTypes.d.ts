...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    approach: Schema.Attribute.Component<'shared.approach', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    headings: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiClientsPageClientsPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Our Client page \u2014 Open Projects and Private Projects with client logos';
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bottomCta: Schema.Attribute.Component<'shared.bottom-cta', false>;
    buttons: Schema.Attribute.Component<'shared.contact-buttons', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heading: Schema.Attribute.String & Schema.Attribute.Required;
    info: Schema.Attribute.Component<'shared.contact-info', false>;
    lead: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiInfoInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::info.info'> &
      Schema.Attribute.Private;
    process: Schema.Attribute.Component<'shared.process', false>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiServicePageContentServicePageContent
  extends Struct.SingleTypeSchema {
  collectionName: 'service_page_contents';
  info: {
    description: 'Service page content';
    displayName: 'Service-page-content';
    pluralName: 'service-page-contents';
    singularName: 'service-page-content';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    focusLead: Schema.Attribute.Text & Schema.Attribute.Required;
    focusTitle: Schema.Attribute.String & Schema.Attribute.Required;
    heading: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::service-page-content.service-page-content': ApiServicePageContentServicePageContent;
